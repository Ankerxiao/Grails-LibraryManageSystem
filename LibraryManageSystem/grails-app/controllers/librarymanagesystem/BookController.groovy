...
class BookController {
    ...
    def create() {
        ...
        render(view: "create", model: [Book: new Book(params), Author: Author.getAll()])

//        respond new Book(params)
    }

    def mySave(Book book) {
        if (book == null) {
            notFound()
            return
        }
    ...
    def edit(Long id) {
//        respond bookService.get(id)
        render(view: "edit", model: [book: bookService.get(id), Author: Author.getAll()])
    }
